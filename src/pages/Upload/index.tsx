...
import {
  Card, Upload, Button, Table, Tag, Space, Progress, message, Typography, Modal,
} from 'antd'
import { motion } from 'framer-motion'
import {
  InboxOutlined, UploadOutlined, FileTextOutlined, FilePdfOutlined,
  FileExcelOutlined, ReloadOutlined, EyeOutlined,
